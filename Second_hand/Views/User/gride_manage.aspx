<%@ Page Title="" Language="C#" MasterPageFile="~/Views/User/User.Master" AutoEventWireup="true" CodeBehind="gride_manage.aspx.cs" Inherits="Second_hand.Views.User.WebForm1" EnableEventValidation="false" %>
        ...
        <div class="row">
            <div class="col-md-3">
                <form>
                    ...
                    <div class="d-grid">       
                        <asp:Button ID="rebtn" runat="server" Text="修改" class="btn btn-success btn-block" OnClick="rebtn_Click"/>
                    </div>
                    <br />

                    <div class="d-grid">       
                       <asp:Button ID="resetbtn" runat="server" Text="重置" class="btn btn-success btn-block" OnClick="resetbtn_Click"/>
                    </div>
                    <br />
            </form>
            ...
            <div class="col-md-9">               
                 <asp:GridView ID="grideview1" runat="server" 
                     class="table" CellPadding="4" ForeColor="#333333" GridLines="Horizontal" 
                     OnSelectedIndexChanged="CategoriesGV_SelectedIndexChanged">
